...
// Bufferization hooks for the NPUOp dialect.
//-----------------------------------------------------------------------
...
void mlir::iree::compiler::Dialect::NPUOp::
    registerNPUOpBufferizableOpInterfaceExternalModels(
        DialectRegistry &registry) {
  registry.addExtension(+[](MLIRContext *ctx, NPUDialect *dialect) {
    (void)dialect; // Unused.
